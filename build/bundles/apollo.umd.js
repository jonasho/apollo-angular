(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('apollo-client-rxjs'), 
require('apollo-client'), require('rxjs/observable/from'), require('rxjs/operator/observeOn'), require('rxjs/scheduler/queue'), require('rxjs/Observable')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'apollo-client-rxjs', 'apollo-client', 'rxjs/observable/from', 
'rxjs/operator/observeOn', 'rxjs/scheduler/queue', 'rxjs/Observable'], factory) :
	(factory((global.ng = global.ng || {}, global.ng.apollo = global.ng.apollo || 
{}),global.ng.core,global.apolloClientRxjs_index,global.apolloClient_index,global.Rx.Observable,global.Rx.Observable.prototype,global.Rx.Scheduler,global.Rx));
}(this, (function 
}(exports,_angular_core,apolloClientRxjs_index,apolloClient_index,rxjs_observable_from,rxjs_operator_observeOn,rxjs_scheduler_queue,rxjs_Observable) { 'use 
}strict';
...
var CLIENT_MAP_WRAPPER = new _angular_core.OpaqueToken('apollo/client-map-wrapper'); var CLIENT_MAP = new _angular_core.OpaqueToken('apollo/client-map'); /**
 * @template T
 * @param {?} promiseFn
 * @return {?}
...
var APOLLO_DIRECTIVES = [
    SelectPipe, ]; var APOLLO_PROVIDERS = [
    provideApollo, ]; /**
 * @param {?} clientFn
 * @return {?}
...
exports.SelectPipe = SelectPipe; exports.Apollo = Apollo; exports.ApolloBase = ApolloBase; exports.provideClientMap = provideClientMap; 
exports.ApolloQueryObservable = ApolloQueryObservable; exports.CLIENT_MAP = CLIENT_MAP; exports.CLIENT_MAP_WRAPPER = CLIENT_MAP_WRAPPER; exports.ApolloModule = 
ApolloModule; exports.APOLLO_PROVIDERS = APOLLO_PROVIDERS; exports.APOLLO_DIRECTIVES = APOLLO_DIRECTIVES; exports.defaultApolloClient = defaultApolloClient; 
